...
plt.hist(spectrum_resol, bins, color="black", label="total")
plt.hist(spectrum_cut1, bins, color="blue", label="cut1")
plt.hist(spectrum_cut2, bins, color="red", label="cut2")
plt.hist(spectrum_cut3, bins,color="gray",label="cut3")
